...
import Header from "../components/Header.jsx"; // CRITICAL: Update extension
import ProductCard from "../components/ProductCard.jsx"; // CRITICAL: Update extension

// Define the structure for product data
const ARTIFACTS_COLLECTION = "artifacts";
const APP_ID = "default-app-id"; // This would be the __app_id in a live environment
...
const HomePage = () => {
  ...
  useEffect(() => {
    ...
    // This listener will run once initially and then every time the data changes.
    ...
    if (isLoading) {
      return (
        <p className="text-center py-10 text-xl text-gray-600">
          Loading authentic Kenyan artifacts...
        </p>
      );
    }
      ...
      return (
        <div className="text-center py-10">
          ...
          <p className="text-gray-500">
            Please add some documents to the
            'artifacts/default-app-id/public/data/artifacts' collection in
            Firestore.
          </p>
        </div>
      );
    ...
    <div className="min-h-screen flex flex-col bg-gray-50 font-sans">
      ...
      <footer className="bg-white border-t border-gray-200 mt-12 py-4">
        <div className="container mx-auto text-center text-gray-500 text-sm">
          © 2025 Makindu Artifacts. All rights reserved.
        </div>
      </footer>
    </div>
  );
